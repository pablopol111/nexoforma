  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch('/api/login', {
        ...
        body: JSON.stringify({ username: normalizeUsername(username), password, next: searchParams.get('next') }),
      });
      ...
      setResult({ success: false, message: error instanceof Error ? error.message : 'No se pudo iniciar sesión.' });
    } finally {
      setLoading(false);
    }
  }
